function Footer(){
      return(
            <div>
                  ...
                  <div className="bg-slate-400 px-4 py-6 bg-neutral-secondary-soft md:flex md:items-center md:justify-between">
                        <span className="text-sm text-body sm:text-center">© 2026 <a href="https://flowbite.com/">SmartLearn.AI</a>. All Rights Reserved.
                        </span>
