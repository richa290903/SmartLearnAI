from sqlalchemy import Column,Integer,String,Text,Date,ForeignKey,Time,Float,DateTime,UniqueConstraint,Boolean
...
class CourseView(Base):
    ...
    courseview_id = Column(Integer, primary_key=True, index=True,autoincrement=True)
